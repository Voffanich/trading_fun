...
- [ ] function finding distance to stop loss based on stop loss determining mode
- [ ] function finding distance to take profit based on take profit determining mode  
