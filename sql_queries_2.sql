...
(SELECT strftime('%Y-%m-%d', datetime) AS date, ROUND(SUM(2 * ((stop_dist_perc - 0.02)/(take_dist_perc + 0.02))), 3) AS profit, COUNT(*) AS profitable_deals, 
    ROUND(SUM(2 * ((stop_dist_perc - 0.02)/(take_dist_perc + 0.02))) / COUNT(*), 3) AS average_profit FROM deals
WHERE status = 'loss' AND strftime("%Y-%m-%d %H:%M:%S", datetime) > "2023-08-18 00:00:00"
...
WHERE status = 'win' AND strftime("%Y-%m-%d %H:%M:%S", datetime) > "2023-08-18 00:00:00"
...
SELECT ROUND(SUM(2 * ((stop_dist_perc - 0.02)/(take_dist_perc + 0.02))), 3) as total_profit_2p FROM deals
WHERE status = 'loss';
...
SELECT ROUND(SUM(2 / profit_loss), 3) as total_profit_2p FROM deals
WHERE status = 'loss';
...
SELECT  profit_table.date, profit - loss as day_result, profit, profitable_deals, average_profit, loss, lost_deals, average_loss FROM 
(SELECT strftime('%Y-%m-%d', datetime) AS date, ROUND(SUM(1.5 * ((stop_dist_perc - 0.02)/(take_dist_perc + 0.02))), 3) AS profit, COUNT(*) AS profitable_deals, 
    ROUND(SUM(1.5 * ((stop_dist_perc - 0.02)/(take_dist_perc + 0.02))) / COUNT(*), 3) AS average_profit FROM deals
WHERE status = 'loss' AND strftime("%Y-%m-%d %H:%M:%S", datetime) > "2023-08-18 00:00:00"
GROUP BY date) as profit_table
INNER JOIN 
...
SELECT ROUND(SUM(1.5 * ((stop_dist_perc - 0.02)/(take_dist_perc + 0.02))), 3) as total_profit_15p FROM deals
WHERE status = 'loss';
...
SELECT  profit_table.date, profit - loss as day_result, profit, profitable_deals, average_profit, loss, lost_deals, average_loss FROM 
(SELECT strftime('%Y-%m-%d', datetime) AS date, ROUND(SUM(1 * ((stop_dist_perc - 0.02)/(take_dist_perc + 0.02))), 3) AS profit, COUNT(*) AS profitable_deals, 
    ROUND(SUM(1 * ((stop_dist_perc - 0.02)/(take_dist_perc + 0.02))) / COUNT(*), 3) AS average_profit FROM deals
WHERE status = 'loss' AND strftime("%Y-%m-%d %H:%M:%S", datetime) > "2023-08-18 00:00:00"
GROUP BY date) as profit_table
INNER JOIN 
...
SELECT ROUND(SUM(1 * ((stop_dist_perc - 0.02)/(take_dist_perc + 0.02))), 3) as total_profit_1p FROM deals
WHERE status = 'loss';
...
-- CORRECT DIRECT STRATEGY

SELECT  profit_table.date, profit - loss as day_result, profit, profitable_deals, average_profit, loss, lost_deals, average_loss FROM 
(SELECT strftime('%Y-%m-%d', datetime) AS date, ROUND(SUM(2 * (take_dist_perc - 0.02)/(stop_dist_perc + 0.02)), 3) AS profit, COUNT(*) AS profitable_deals, 
    ROUND(SUM(2 * (take_dist_perc - 0.02)/(stop_dist_perc + 0.02)) / COUNT(*), 3) AS average_profit FROM deals
WHERE status = 'win' 
-- WHERE status = 'win' AND strftime("%Y-%m-%d %H:%M:%S", datetime) > "2023-08-18 00:00:00" 
GROUP BY date) as profit_table
INNER JOIN 
...
SELECT ROUND(SUM(2 * (take_dist_perc - 0.02)/(stop_dist_perc + 0.02)), 3) as total_profit_direct FROM deals
WHERE status = 'win';

SELECT COUNT(*) * 2 as total_loss_direct FROM deals
WHERE status = 'loss';
